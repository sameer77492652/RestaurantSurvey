...
public class MainActivityNew extends AppCompatActivity {
    ...
    private void initData() {
        ...
        if(userDetailsPref.getStringPref(MainActivityNew.this, UserDetailsPref.LANGUAGE_TYPE).length() == 0){
            userDetailsPref.putStringPref(MainActivityNew.this, UserDetailsPref.LANGUAGE_TYPE, Constants.lang_english);

        }else{
            switch (userDetailsPref.getStringPref(MainActivityNew.this, UserDetailsPref.LANGUAGE_TYPE)){
                case "english" :
    ...
    private void initListener() {
        ...
        tvHindi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvEnglish.setBackgroundColor(getResources().getColor(R.color.white));
                tvEnglish.setTextColor(getResources().getColor(R.color.black));
                userDetailsPref.putStringPref(MainActivityNew.this, UserDetailsPref.LANGUAGE_TYPE, Constants.lang_hindi);
            }
        });
    }
            ...
            StringRequest strRequest1 = new StringRequest(Request.Method.GET, AppConfigURL.URL_INIT,
                    new com.android.volley.Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response != null) {
                                userDetailsPref.putStringPref(MainActivityNew.this, UserDetailsPref.RESPONSE, response);
                                try {
